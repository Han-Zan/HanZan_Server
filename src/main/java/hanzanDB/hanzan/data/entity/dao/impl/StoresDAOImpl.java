...
import hanzanDB.hanzan.data.entity.dto.Response.Store.StoreCombResponseDto;
...
public class StoresDAOImpl implements StoresDAO {
    ...
    public StoresResponseDto getStores(String kakaoId) throws Exception {
        ...
        if(stores.isPresent()) {
            ...
            List<StoreCombResponseDto> arr = new ArrayList<>();
            for(Combination combi : newstore.getCombinationList()) {
                StoreCombResponseDto combreq = new StoreCombResponseDto();
